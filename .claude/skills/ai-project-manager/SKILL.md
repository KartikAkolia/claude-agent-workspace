...
`claude-agent-templates/` (this repo's own blank AGENTS.md/SPEC.md/ROADMAP.md/TASKS.md
scaffolding) to the target repository. Remove irrelevant sections instead of
